...
const Footer = () => {
  return (
    <>
      ...
      <div className="container-fluid flex gap-15 ml-0 mt-1 bg-black p-1 text-white mx-auto footcont">
        <div className="w-2/5 space-x-4  space-y-6 footitm pt-4">
          <h3
            style={{
              fontWeight: "700",
              fontSize: "24px",
        ...
        <div className=" md:flex flex-col  w-1/5  space-y-6 footitm pt-4">
          <h2 className="text-xl font-medium" style={{ color: "grey" }}>
            Useful Links
          </h2>
      ...
      <hr
        className="w-full"
        style={{ backgroundColor: "grey", height: "1px", border: "none" }}
      />
